...
## Project Structure
    ...
    ├── testapiautoconnecto_73285  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_73285`
...
2. Clone this repo and `cd testapiautoconnecto_73285`
